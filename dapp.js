window.addEventListener("load", function() {
    if (typeof window.ethereum !== 'undefined'){
        ...
        console.log("No wallet is available")
        alert("You need to install MetaMask or another wallet")
        let mmDetected = document.getElementById("mm-detected")
        mmDetected.innerHTML = "MetaMask has not been detected - please connect your wallet"
    }
})
...
const contractAddress = "0x1dea6bdd2074b671686a5403bd50ee8d55d4f3fc";
...
balanceReturn.onclick = async () => {
    ...
    const userBalance = await autoMint.methods.balanceOf(ethereum.selectedAddress).call({ from: ethereum.selectedAddress});
 
    document.getElementById("balance-return").innerHTML = "You currently own " + userBalance + " AutoMobiles";
    
}

const idReturn = document.getElementById("id-button");
idReturn.onclick = async () => {
    await ethereum.request({ method: 'eth_requestAccounts'})
	...
	const autosOwned = document.getElementById("autos-owned").value;
...
const idTransfer = document.getElementById("transfer-button");
idTransfer.onclick = async () => {
    const transferID = document.getElementById("input-ID").value;
    const transferAddress = document.getElementById("input-address").value;
